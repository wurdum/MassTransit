namespace MassTransit.AzureServiceBusTransport.Topology
{
    ...
    public class ServiceBusSendTopology :
        SendTopology,
        IPubSubSendTopologyConfigurator
    {
        ...
        {
            return GetMessageTopology<T>() as IPubSubMessageSendTopologyConfigurator<T>;
        }

        IPubSubMessageSendTopologyConfigurator<T> IPubSubSendTopologyConfigurator.GetMessageTopology<T>()
        {
            return GetMessageTopology<T>() as IPubSubMessageSendTopologyConfigurator<T>;
        }
