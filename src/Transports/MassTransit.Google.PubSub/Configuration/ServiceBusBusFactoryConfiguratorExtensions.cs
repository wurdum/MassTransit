namespace MassTransit
{
    ...
    public static class ServiceBusBusFactoryConfiguratorExtensions
    {
        ...
        public static void Host(this IPubSubBusFactoryConfigurator configurator, Uri hostAddress,
        ...
        /// <param name="configure">A callback to further configure the service bus</param>
        /// <returns>The service bus host</returns>
        public static void Host(this IPubSubBusFactoryConfigurator configurator, string connectionString,
            Action<IServiceBusHostConfigurator> configure = null)
        {
        ...
        public static void ReceiveEndpoint(this IPubSubBusFactoryConfigurator configurator, Action<IPubSubReceiveEndpointConfigurator> configure = null)
        {
        ...
        /// <param name="configure"></param>
        public static void ReceiveEndpoint(this IPubSubBusFactoryConfigurator configurator, IEndpointDefinition definition,
