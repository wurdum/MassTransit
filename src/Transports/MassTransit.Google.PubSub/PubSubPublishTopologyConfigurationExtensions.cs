...
namespace MassTransit
{
    ...
    public static class PubSubPublishTopologyConfigurationExtensions
    {
        /// <summary>
        ...
        public static void AddPublishMessageTypesFromNamespaceContaining<T>(this IPubSubBusFactoryConfigurator configurator,
            Action<IPubSubMessagePublishTopologyConfigurator, Type>? configure = null, Func<Type, bool>? filter = null)
        {
        ...
        /// <param name="configure"></param>
        /// <param name="filter"></param>
        public static void AddPublishMessageTypesFromNamespaceContaining(this IPubSubBusFactoryConfigurator configurator, Type type,
            Action<IPubSubMessagePublishTopologyConfigurator, Type>? configure = null, Func<Type, bool>? filter = null)
        {
            if (type == null)
        ...
        /// <param name="configure"></param>
        public static void AddPublishMessageTypes(this IPubSubBusFactoryConfigurator configurator, IEnumerable<Type> messageTypes,
            Action<IPubSubMessagePublishTopologyConfigurator, Type>? configure = null)
        {
