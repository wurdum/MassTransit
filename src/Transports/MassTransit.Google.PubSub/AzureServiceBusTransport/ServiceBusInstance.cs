namespace MassTransit.AzureServiceBusTransport
{
    ...
    public class ServiceBusInstance :
        TransportBusInstance<IPubSubReceiveEndpointConfigurator>,
        ISubscriptionEndpointConnector
    {
        readonly IServiceBusHost _host;

        public ServiceBusInstance(IBusControl busControl, IHost<IPubSubReceiveEndpointConfigurator> host, IHostConfiguration hostConfiguration,
