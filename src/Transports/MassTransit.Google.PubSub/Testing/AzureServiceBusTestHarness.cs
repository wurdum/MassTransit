namespace MassTransit.Testing
{
        ...
        BusTestHarness
    {
        ...
        public event Action<IPubSubBusFactoryConfigurator> OnConfigureServiceBusBus;
        public event Action<IPubSubReceiveEndpointConfigurator> OnConfigureServiceBusReceiveEndpoint;

        protected virtual void ConfigureServiceBusBus(IPubSubBusFactoryConfigurator configurator)
        {
            OnConfigureServiceBusBus?.Invoke(configurator);
        }

        protected virtual void ConfigureServiceBusReceiveEndpoint(IPubSubReceiveEndpointConfigurator configurator)
        {
