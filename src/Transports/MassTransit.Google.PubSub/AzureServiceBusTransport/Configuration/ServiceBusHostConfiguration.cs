namespace MassTransit.AzureServiceBusTransport.Configuration
{
    ...
    public class ServiceBusHostConfiguration :
        BaseHostConfiguration<IServiceBusEntityEndpointConfiguration, IPubSubReceiveEndpointConfigurator>,
        IServiceBusHostConfiguration
    {
        ...
        IPubSubHostSettings _hostSettings;
        ...
        public IPubSubHostSettings Settings
        {
            get => _hostSettings;
        ...
        {
            _messageNameFormatter = new PubSubMessageNameFormatter("~");
        ...
        {
            _messageNameFormatter = new PubSubMessageNameFormatter("_");
            _topologyConfiguration.Message.SetEntityNameFormatter(new MessageNameFormatterEntityNameFormatter(_messageNameFormatter));
        }

        public void SetNamespaceSeparatorTo(string separator)
        {
            _messageNameFormatter = new PubSubMessageNameFormatter(separator);
            _topologyConfiguration.Message.SetEntityNameFormatter(new MessageNameFormatterEntityNameFormatter(_messageNameFormatter));
        }

        public override void ReceiveEndpoint(IEndpointDefinition definition, IEndpointNameFormatter endpointNameFormatter,
            Action<IPubSubReceiveEndpointConfigurator> configureEndpoint = null)
        {
        ...
        public override void ReceiveEndpoint(string queueName, Action<IPubSubReceiveEndpointConfigurator> configureEndpoint)
        {
            CreateReceiveEndpointConfiguration(queueName, configureEndpoint);
        }

        public void ApplyEndpointDefinition(IPubSubReceiveEndpointConfigurator configurator, IEndpointDefinition definition)
        {
        ...
        public IServiceBusReceiveEndpointConfiguration CreateReceiveEndpointConfiguration(ReceiveEndpointSettings settings,
            IServiceBusEndpointConfiguration endpointConfiguration, Action<IPubSubReceiveEndpointConfigurator> configure)
        {
            if (settings == null)
