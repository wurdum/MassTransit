...
namespace MassTransit.AzureServiceBusTransport.Topology
{
    ...
    public class ServiceBusMessagePublishTopology<TMessage> :
        ...
        IPubSubMessagePublishTopologyConfigurator<TMessage>
        where TMessage : class
    {
        ...
        public void AddImplementedMessageConfigurator<T>(IPubSubMessagePublishTopologyConfigurator<T> configurator, bool direct)
            where T : class
        {
        ...
        class ImplementedTypeAdapter<T> :
            ...
            where T : class
        {
            readonly IPubSubMessagePublishTopologyConfigurator<T> _configurator;
            readonly bool _direct;

            public ImplementedTypeAdapter(IPubSubMessagePublishTopologyConfigurator<T> configurator, bool direct)
            {
