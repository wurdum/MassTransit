namespace MassTransit
{
    ...
    public static class ServiceBusConfigurationExtensions
    {
        ...
        /// <returns></returns>
        public static IBusControl CreateUsingAzureServiceBus(this IBusFactorySelector selector, Action<IPubSubBusFactoryConfigurator> configure)
        {
            return PubSubBusFactory.CreateUsingServiceBus(configure);
        }
        ...
        public static void UsingAzureServiceBus(this IBusRegistrationConfigurator configurator,
            Action<IBusRegistrationContext, IPubSubBusFactoryConfigurator> configure = null)
        {
