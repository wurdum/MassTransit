...
namespace MassTransit
{
    ...
    public interface IPubSubBusFactoryConfigurator :
        IBusFactoryConfigurator<IPubSubReceiveEndpointConfigurator>,
        IServiceBusQueueEndpointConfigurator
    {
        new IPubSubSendTopologyConfigurator SendTopology { get; }

        new IPubSubPublishTopologyConfigurator PublishTopology { get; }
        ...
        void Send<T>(Action<IPubSubMessageSendTopologyConfigurator<T>> configureTopology)
            where T : class;
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="configureTopology"></param>
        void Publish<T>(Action<IPubSubMessagePublishTopologyConfigurator<T>>? configureTopology = null)
            where T : class;

        void Publish(Type messageType, Action<IPubSubMessagePublishTopologyConfigurator>? configure = null);
        ...
        /// <returns></returns>
        void Host(IPubSubHostSettings settings);
